...
| ---------------------------- | --------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Help                         | `docker compose run --rm ultrasinger -h`                        | `docker run --rm --name ultrasinger -e PGID=1000 -e PUID=1000 msylvan26/ultrasinger:latest -h`                                                                                                               |
| Process a file               | `docker compose run --rm ultrasinger -i "${url}"`               | `docker run --rm --name ultrasinger -v ultrasinger_user-cache:/home/appuser/.cache -v ./output:/app/UltraSinger/src/output -e PGID=1000 -e PUID=1000 msylvan26/ultrasinger:latest -i "${url}"`               |
| Process a file with language | `docker compose run --rm ultrasinger -i "${url}" --language en` | `docker run --rm --name ultrasinger -v ultrasinger_user-cache:/home/appuser/.cache -v ./output:/app/UltraSinger/src/output -e PGID=1000 -e PUID=1000 msylvan26/ultrasinger:latest -i "${url}" --language en` |
| Shell as appuser             | `docker compose run --rm -it ultrasinger shell`                 | `docker run --rm -it --name ultrasinger --user 1000:1000 -v ultrasinger_user-cache:/home/appuser/.cache -v ./output:/app/UltraSinger/src/output msylvan26/ultrasinger:latest shell`                          |
| Root shell                   | `docker compose run --rm -it ultrasinger root`                  | `docker run --rm -it --name ultrasinger -v ultrasinger_user-cache:/home/appuser/.cache -v ./output:/app/UltraSinger/src/output msylvan26/ultrasinger:latest root`                                            |
...
| Action                       | `docker compose` command                                                                 | `docker` command                                                                                                                                                                   |
| ---------------------------- | ---------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Start container              | `docker compose up`                                                                      | `docker run --rm --name ultrasinger -v ultrasinger_user-cache:/home/appuser/.cache -v ./output:/app/UltraSinger/src/output -e PGID=1000 -e PUID=1000 msylvan26/ultrasinger:latest` |
